...
plt.plot(laminate_quad_thru_tsai_no_in_plane_top,kratos_thru_z_tsai_top, color = '#77B5FE', linewidth=3.0,label = 'ANDES-DKQ',antialiased=True)

plt.plot(laminate_quad_thru_tsai_no_in_plane_bot,kratos_thru_z_tsai_bot, color = '#77B5FE', linewidth=3.0, label = None,antialiased=True)
...
plt.grid()
plt.tick_params(labelsize=labelfontsize)
plt.savefig('navier_plate_composite_quad_tsai.png',bbox_inches="tight")
