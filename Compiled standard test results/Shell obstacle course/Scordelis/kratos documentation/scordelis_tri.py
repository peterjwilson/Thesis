...
plt.plot(dofs,disp_dsg, color = DSG, linewidth=2.0, 
         ...
         markerfacecolor= 'None', label = 'Kratos thick tri',antialiased=True)
#
...
plt.plot(dofs,disp_kratos_tri, color = KRATOSTRI, linewidth=2.0, 
         ...
         markerfacecolor= 'None', label = 'Kratos thin tri',antialiased=True)
...
plt.savefig('scordelis_structured_tri_results_kratos.png',bbox_inches="tight")
plt.show()
