...
\section{Tsai-Wu failure criterion implementation}
...
The extension from elements limited to isotropic materials to orthotropic laminates has been detailed by briefly recalling the relevant composite theory and outlining it's implementation in Kratos. After covering the composite constitutive matrix formulation and implementation, composite stress recovery across the laminate was presented. The Tsa-Wu failure criterion implementation finalized the extension of elements limited to isotropic materials to orthotropic composite laminates.