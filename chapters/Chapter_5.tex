...
\subsection{Linear static: composite barrel vault}
...
\subsection{Linear static: clamped cylinder}

asdfdsf

\subsection{Non-linear static: composite hinged cylindrical roof}
