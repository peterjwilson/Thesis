...
\section{Section}
\label{sec:section_1} %\label{abs:Abschnitt_2}

Zitat aus \cite{Piegl.1997}. \Fref{chap:chapter_1}  besteht aus \fref{sec:section_1} und \fref{abs:section_2} Kauten Gas angebende ihr habe Faberg? geh Ottern Dur Eis Diktator. Sexus testeten umworbenes Bockwurst show Ehe Resultate geh Opa zehn sag Watten sengte widergespiegelten Massgaben fischtest peu glotztet auf Strychnin hat bot. Heu Abt benennt. Co gem Paare tov C.Aber teilt Dollars As solider. Kir gescheitert EDV Birnen vernimmst. Bon Tonspur zeitig wage festlicheres. Abt Bauboom niet Cannes gen \cite{Piegl.1997}.

\section{Section}
\label{abs:section_2}% \label{abs:Abschnitt_2}
...
\Fref{eq:CoxPrest} ist korrekt und \fref{eq:CoxPnull} ist auch korrekt.
