...
\section{Lamina strain and stress recovery}

aasdfasdfasdfasdf

\subsection{Lamina strain recovery}

Owing to the dimensional reduction from 3D to 2D, the generalized shell strains $\bar{\boldsymbol{\epsilon}}$ are referred to the midplane of the laminate.
